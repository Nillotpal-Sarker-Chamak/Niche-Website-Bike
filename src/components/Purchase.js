...
const PlaceDetails = () => {
    ...
    const purchase = (e) => {
        e.preventDefault();
        axios.post('http://localhost:5000/purchase', { user: user, email: userEmail, phone: phone.current.value, address: address.current.value, Product: product[0], request: 0 }).then((res) => {
