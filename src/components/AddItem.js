...
const AddItem = () =>{
    ...
    const addItem=(e)=>{
        ...
        axios.post('http://localhost:5000/addproducts',{Name:place.current.value, Image:imageUrl.current.value,price:price.current.value, Description:description.current.value}).then((res)=>{
